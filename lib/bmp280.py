...
if __name__ == "__main__":
    ...
    # Indoor has the most oversampling and noise reduction -- good for our balloon application
    bmp = BMP280(i2c, use_case=BMP280_CASE_INDOOR)

    print(bmp.chip_id.hex())

    while True:
        print(f"Temp: {bmp.temperature:0.2f}, Pressure: {bmp.pressure:0.2f}")
        time.sleep_ms(250)